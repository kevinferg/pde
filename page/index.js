...
var ASM_CONSTS = {
  1077245: () => { if (document.fullscreenElement) return 1; },  
 1077291: () => { return Module.canvas.width; },  
 1077323: () => { return parseInt(Module.canvas.style.width); },  
 1077371: () => { document.exitFullscreen(); },  
 1077398: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 1077470: () => { if (document.fullscreenElement) return 1; },  
 1077516: () => { return Module.canvas.width; },  
 1077548: () => { return screen.width; },  
 1077573: () => { document.exitFullscreen(); },  
 1077600: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 1077794: () => { return window.innerWidth; },  
 1077820: () => { return window.innerHeight; },  
 1077847: () => { if (document.fullscreenElement) return 1; },  
 1077893: () => { return Module.canvas.width; },  
 1077925: () => { return parseInt(Module.canvas.style.width); },  
 1077973: () => { if (document.fullscreenElement) return 1; },  
 1078019: () => { return Module.canvas.width; },  
 1078051: () => { return screen.width; },  
 1078076: () => { return window.innerWidth; },  
 1078102: () => { return window.innerHeight; },  
 1078129: () => { if (document.fullscreenElement) return 1; },  
 1078175: () => { return Module.canvas.width; },  
 1078207: () => { return screen.width; },  
 1078232: () => { document.exitFullscreen(); },  
 1078259: () => { if (document.fullscreenElement) return 1; },  
 1078305: () => { return Module.canvas.width; },  
 1078337: () => { return parseInt(Module.canvas.style.width); },  
 1078385: () => { document.exitFullscreen(); },  
 1078412: ($0) => { Module.canvas.style.opacity = $0; },  
 1078450: () => { return screen.width; },  
 1078475: () => { return screen.height; },  
 1078501: () => { return window.screenX; },  
 1078528: () => { return window.screenY; },  
 1078555: () => { return window.devicePixelRatio; },  
 1078591: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1078644: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1078695: () => { Module.canvas.style.cursor = 'none'; },  
 1078732: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1078988: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1079039: () => { if (document.pointerLockElement) return 1; },  
 1079086: () => { if (document.fullscreenElement) return 1; },  
 1079132: () => { return window.innerWidth; },  
 1079158: () => { return window.innerHeight; }
};
